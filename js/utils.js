...
function showSyncStatus(state){
  ...
  if(!el){
    ...
    el.id='syncStatus';
    el.style.cssText='position:fixed;top:64px;right:10px;z-index:999;font-family:DM Mono,monospace;font-size:10px;padding:4px 10px;border-radius:0;transition:all 0.3s;pointer-events:none;';
