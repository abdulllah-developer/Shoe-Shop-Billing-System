...
function applyUserSession(){
  ...
  // Bottom nav — Products page is viewable by all roles (read-only for
  // salesman; edit/delete/import actions are separately gated by isAdmin()
  // checks), matching the desktop sidebar which also shows this to everyone.
